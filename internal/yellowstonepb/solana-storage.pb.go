...
var (
	file_solana_storage_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
	file_solana_storage_proto_msgTypes  = make([]protoimpl.MessageInfo, 19)
	file_solana_storage_proto_goTypes   = []any{
